...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('coupons.store') }}" method="post" class="needs-validation" novalidate>
                ...
                <div class="row">
                    <div class="col-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom01" placeholder="Code"
                            required name="code">
                    ...
                    <div class="col-4 mb-3">
                        ...
                        <input type="date" class="form-control" id="validationCustomUsername" placeholder="Expire Date"
                            aria-describedby="inputGroupPrepend" required name="expire_at">
